          ...
          <div className="relative">
            ...
            {isMenu && (
              <motion.div
                ...
                className="w-40 bg-gray-50 rounded-lg shadow-xl absolute top-12 right-0 flex flex-col "
              >
                {user && user.email === "simeonoffiong@gmail.com" && (
                  <Link to="/createitem">
          ...
          {isMenu && (
            ...
            >
              ...
              <ul className="flex flex-col">
                <li className="text-base text-textColor hover:text-headingColor hover:bg-slate-100 duration-100 px-4 py-2 transition-all ease-in-out cursor-pointer">
                  Home
                </li>
                <li className="text-base text-textColor hover:text-headingColor hover:bg-slate-100 duration-100 px-4 py-2 transition-all ease-in-out cursor-pointer">
                  Menu
